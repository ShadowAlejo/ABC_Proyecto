"""Worker thread que ejecuta el pipeline de video en segundo plano sin tracker y emite señales Qt."""
import time
...
class PipelineWorker(QThread):
    """Ejecuta detección + ID/Re-ID en un hilo separado.
    ...
    def run(self):
        ...
        try:
            ...
            scheduler = FrameScheduler(target_fps=self.config["video"].get("target_fps", 30))
